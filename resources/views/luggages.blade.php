         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Luggage Type List</h4>
               </div>
               <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" href="add_luggage" aria-label="Add" data-bs-original-title="Add">
            ...
            <div class="card-body px-0">
               ...
               <table id="datatable" class="table table-striped" data-toggle="data-table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{$row->luggage_name}}</td>

                        <td>
                           <div class="flex align-items-center list-user-action">

                              <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit" href="{{ route('edit_luggage_type', ['id' => $row->id]) }}" aria-label="Edit" data-bs-original-title="Edit">
                                 <span class="btn-inner">
                              ...
                              <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" href="{{ route('delete_luggage_type', ['id' => $row->id]) }}" aria-label="Delete" data-bs-original-title="Delete">
                                 <span class="btn-inner">
