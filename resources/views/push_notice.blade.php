      ...
      <div class="card">
         <div class="card-header">
            ...
            <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
               href="add_push_notification" aria-label="Add" data-bs-original-title="Add">
                     ...
                     <td>
                        <div class="flex align-items-center list-user-action">
                           ...
                           <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                              data-original-title="Edit" href="{{ route('edit_push_notification',['id'=>$row->id]) }}"
                           ...
                           <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                              href="{{ route('delete_push_notification',['id'=>$row->id]) }}" aria-label="Delete"
