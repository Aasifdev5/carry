                  ...
                  <form action="{{route('save_vehicle')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                     ...
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Vehicle
                           Nickname:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="nick_name" name="nick_name" value="{{old('nick_name')}}" placeholder="Enter Your Vehicle Nick Name">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="vehicle_name" name="ride_type" value="{{old('ride_type')}}" placeholder="Enter Your Ride Type">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="seats" name="seats" value="{{old('seats')}}" placeholder="Enter Your Seats">
                     ...
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Departure
                           address:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="departure_address" name="departure_address" value="{{old('departure_address')}}" placeholder="Enter Your Departure Address">
                     ...
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Destination
                           address:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="destination_address" name="destination_address" value="{{old('destination_address')}}" placeholder="Enter Your Destination Address">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="fixed_price" name="fixed_price" value="{{old('fixed_price')}}" placeholder="Enter Your Fixed Price">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="luggage" name="luggage" value="{{old('luggage')}}">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           ...
                           <textarea class="form-control" rows="4" name="description" autofocus> {{old('description')}} </textarea>
