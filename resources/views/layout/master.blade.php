      ...
      <div class="sidebar-body pt-0 data-scrollbar">
         <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
               ...
               ?>
                  <li class="nav-item">
                     <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-vehicle" role="button" aria-expanded="false" aria-controls="sidebar-vehicle">
                        <i class="icon">
                           <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-20">
                ...
                <a class="nav-link {{ request()->is('add_user') ? 'active':'' }}" href="add_user">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-language" role="button" aria-expanded="false" aria-controls="sidebar-user">
                        <i class="icon">
                     ...
                     <ul class="sub-nav collapse" id="sidebar-language" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                           <a class="nav-link {{ request()->is('languages') ? 'active':'' }}" href="languages">
                              <i class="icon">
                                 <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                       <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <li class="nav-item">
                     <a class="nav-link {{ request()->is('distributor_management') ? 'active':'' }}" href="distributor_management">
                        <i class="icon">
