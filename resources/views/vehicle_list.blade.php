   ...
   <div class="col-sm-12">
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            ...
            <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" href="add_vehicle" aria-label="Add" data-bs-original-title="Add">
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="flex align-items-center list-user-action">
                              ...
                              <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit" href="{{ route('edit_vehicle', ['id' => $vehicle->id]) }}" aria-label="Edit" data-bs-original-title="Edit">
                                 <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" href="{{ route('delete_vehicle', ['id' => $vehicle->id]) }}" aria-label="Delete" data-bs-original-title="Delete">
                                 <span class="btn-inner">
