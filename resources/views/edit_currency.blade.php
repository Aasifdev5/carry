         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="new-user-info">
                  <form action="{{route('update_currency')}}" method="POST" enctype="multipart/form-data"
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="currency_name" name="currency_name"
                              value="{{$currency->currency_name}}" placeholder="Enter Currency Name">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="currency_symbol" name="currency_symbol"
                              value="{{$currency->currency_symbol}}" placeholder="Enter Currency Symbol">
