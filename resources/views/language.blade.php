         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">{{ __('Languages') }} {{ __('List') }}</h4>
               </div>
               <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" href="add_language" aria-label="Add" data-bs-original-title="Add">
               ...
               <table id="datatable" class="table table-striped" data-toggle="data-table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{$row->name}}</td>
                        <td>{{$row->code}}</td>
                        <td><img src="images/language/{{$row->language_photo}}" class="img-circle" width="100" height="70"></td>
                        <td>
