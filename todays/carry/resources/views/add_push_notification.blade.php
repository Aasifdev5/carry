         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="new-user-info">
                  <form action="{{route('save_push_notification')}}" method="POST" class="form-horizontal">
                        ...
                        <div class="col-sm-12">
                           <div class="form-outline">
                              <textarea class="form-control" id="textAreaExample" name="message" placeholder="" rows="4"
                                 style=" border: 1px solid;border-radius: 20px;"></textarea>
                     ...
                     <div class="form-group">
                        <div class="col-sm-12">
                           <button type="submit" class="btn btn-primary btn-block pull-right"
                              style="border-radius: 35px;width: 70%;">Send Message</button>
                        </div>
