    ...
    <!-- loader END -->
      ...
      <section class="login-content">
         <div class="row m-0 align-items-center bg-white vh-100">            
               ...
               <img src="images/auth/05.png" class="img-fluid gradient-main animated-scaleX" alt="images">
            </div>
            <div class="col-md-6">               
                           ...
                           <form action="{{ route('registeration')}}" method="post">
                            ...
                            @csrf
                              <div class="row">
                                 <div class="col-lg-10">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="full-name" value="{{old('name')}}" name="name" placeholder=" ">
                              ...
                              <p class="mt-3 text-center">
                                 Already have an Account <a href="/" class="text-underline">Sign In</a>
                              </p>
                           </form>
                        </div>
                     </div>    
