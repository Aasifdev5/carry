         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               ...
               <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                  href="add_currency" aria-label="Add" data-bs-original-title="Add">
                        ...
                        <td>
                           <div class="flex align-items-center list-user-action">
                              ...
                              <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                 ...
                                 href="{{ route('edit_currency', ['id' => $row->id]) }}" aria-label="Edit"
                              ...
                              <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                 href="{{ route('delete_currency', ['id' => $row->id]) }}" aria-label="Delete"
